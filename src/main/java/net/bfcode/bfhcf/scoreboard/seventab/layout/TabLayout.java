package net.bfcode.bfhcf.scoreboard.seventab.layout;
...
import net.bfcode.bfhcf.scoreboard.seventab.util.Reflection;
...
public class TabLayout {
	...
	private final SevenTab instance;
	private final Player player;
	
	public TabLayout(SevenTab instance, Player player) {
