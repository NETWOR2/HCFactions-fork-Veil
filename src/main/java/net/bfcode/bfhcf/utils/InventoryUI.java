...
public class InventoryUI
{
    ...
    public class Inventory2D
    {
        ...
        public Inventory toInventory() {
            ...
            Inventory inventory = Bukkit.getServer().createInventory((InventoryHolder)new InventoryUIHolder(InventoryUI.this, this.title, this.rows * 9), this.rows * 9, this.title);
