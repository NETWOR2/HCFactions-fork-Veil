...
public class ActionMessage {
	...
	public AMText addText(String Message) {
		AMText Text = new AMText(CC.translate(Message));
	...
	public void sendToPlayer(Player Player) {
		IChatBaseComponent base = IChatBaseComponent.class.cast(ChatSerializer.a(getFormattedMessage()));//.ChatSerializer.a(getFormattedMessage());
